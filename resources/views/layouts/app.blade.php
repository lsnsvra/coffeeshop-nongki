...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-item-custom { list-style: none; }
        ...
        .sidebar-user-logout:hover { color: #ff6b6b; }
        ...
        .page-breadcrumb a { color: var(--brown-500); text-decoration: none; }
        .page-breadcrumb a:hover { color: var(--brown-700); }
        ...
        .badge-danger  { background: #FDDDDB; color: var(--danger); }
        .badge-info    { background: var(--brown-100); color: var(--brown-700); }
    ...
    <header class="app-header">
        ...
        <div class="header-actions">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2" style="border-radius:var(--radius-md);min-width:200px;">
                    <li class="px-3 py-2">
                        <div style="font-weight:700;font-size:.9rem;">{{ Auth::user()->name }}</div>
                        <div style="font-size:.75rem;color:var(--text-soft);text-transform:capitalize;">{{ Auth::user()->role }}</div>
                    </li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="{{ route('order.history') }}"><i class="bi bi-clock-history me-2"></i>Riwayat Order</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
            ...
            @else
            <a href="{{ route('login') }}" class="btn-primary-custom" style="border-radius:50px;padding:.4rem 1rem;font-size:.8rem;">
    ...
    <aside class="app-sidebar" id="appSidebar">
        ...
        <div class="sidebar-section">
            ...
            <ul style="list-style:none;padding:0;margin:0;">
                <li class="nav-item-custom">
                    <a href="{{ route('menu.index') }}" class="nav-link-custom {{ request()->routeIs('menu.*') ? 'active' : '' }}">
                        <i class="bi bi-cup-hot"></i> Menu Kopi
                    </a>
                </li>
                <li class="nav-item-custom">
                    <a href="{{ route('cart.index') }}" class="nav-link-custom {{ request()->routeIs('cart.*') ? 'active' : '' }}">
                ...
                <li class="nav-item-custom">
                    <a href="{{ route('order.history') }}" class="nav-link-custom {{ request()->routeIs('order.*') ? 'active' : '' }}">
        ...
        <div class="sidebar-section">
            ...
            <ul style="list-style:none;padding:0;margin:0;">
                ...
                <li class="nav-item-custom">
                    <a href="{{ route('manager.laporan') }}" class="nav-link-custom {{ request()->routeIs('manager.laporan*') ? 'active' : '' }}">
        ...
        <div class="sidebar-section">
            ...
            <ul style="list-style:none;padding:0;margin:0;">
                <li class="nav-item-custom">
                    <a href="{{ route('manager.products.index') }}" class="nav-link-custom {{ request()->routeIs('manager.products.index') || request()->routeIs('manager.products.create') || request()->routeIs('manager.products.edit') ? 'active' : '' }}">
                        <i class="bi bi-box-seam"></i> Produk
                    </a>
                </li>
                <li class="nav-item-custom">
                    <a href="{{ route('manager.products.trash') }}" class="nav-link-custom {{ request()->routeIs('manager.products.trash') ? 'active' : '' }}">
        ...
        <div class="sidebar-section">
            ...
            <ul style="list-style:none;padding:0;margin:0;">
                <li class="nav-item-custom">
                    <a href="{{ route('kasir.dashboard') }}" class="nav-link-custom {{ request()->routeIs('kasir.*') ? 'active' : '' }}">
