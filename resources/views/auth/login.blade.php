...
<body>
    ...
    <div class="form-panel">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" id="email" name="email" placeholder="melanggan@nongki.com" value="{{ old('email') }}" required autocomplete="email">
                </div>
            </div>
        ...
        <div class="btn-google" onclick="alert('Fitur Google Login sedang dalam pengembangan. Silakan login menggunakan email dan password.')">
