...
<body>
  ...
  <div class="form-panel">
    ...
    <form action="{{ route('login') }}" method="POST" id="loginForm">
      ...
      <div class="form-group animate-slide delay-3">
        ...
        <div class="input-wrapper">
          ...
          <input type="email" id="email" name="email" placeholder="pelanggan@nongki.com" value="{{ old('email') }}"
    ...
    <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 15px;">
      ...
      <a href="{{ route('login.wa') }}" class="animate-slide delay-7"
        style="display: flex; align-items: center; justify-content: center; gap: 10px; width: 100%; padding: 10px 0; border: 1px solid #3f3f46; border-radius: 8px; background-color: transparent; color: #a1a1aa; font-size: 0.875rem; font-weight: 500; text-decoration: none; transition: all 0.3s ease;"
        onmouseover="this.style.backgroundColor='rgba(37, 211, 102, 0.1)'; this.style.color='#ffffff';"
        onmouseout="this.style.backgroundColor='transparent'; this.style.color='#a1a1aa';">
